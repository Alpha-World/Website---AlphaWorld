<template>
  <div class="bg-white lg:pb-[4rem] pt-[2.5rem] lg:pt-[20rem] lg:pb mt-[12rem]">
    <div class="lg:w-4/5 mx-auto text-white">
      <Flex :level="2" class="justify-center">
        <div class="bg-[#0027A6] mb-8 lg:mb-20 rounded-xl w-[85%] lg:w-[60%]">
        ...
        <div class="lg:w-full w-[90%]">
          ...
          >
            ...
            >
              ...
              digital
              <span class="text-blue-800 capitalize]"> needs </span>
            </h4>
            ...
            >
              ...
              <ul class="text-stone-900 w-[90%] mx-auto list-disc">
                ...
                <li class="">Digital Crypto Wallet</li>
                <li class="">
...
const textMobile = "Aimed to solve multiple digital problems across several industries in one easy to use app, what sets AlphaWorld apart from the competition is its uncompromising focus on user privacy and security. While other apps exploit your data for profit, AlphaWorld puts users back in control by giving them the power to share and earn, or erase their data from its database." + "<br>" +
  "<br>" +
...
The platform rewards active users who spend time on the platform by offering higher earnings from their data share." + "<br>" +
  "<br>" +

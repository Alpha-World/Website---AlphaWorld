<template>
	<div class="bg-blue-50/60 py-[5.3rem] w-full">
		<div class="">
			...
			<Flex :level="1">
				<h2
					class="text-2xl lg:text-4xl capitalize py-4 font-bold"
				>
		...
		<Grid class="hidden lg:grid gap-8">
			...
			>
				<div
					class="h-full flex flex-col items justify-start items-start"
				>
					<Flex
						:level="1"
						class="basis-2/3 cursor-pointer hover:scale-105 duration-300 relative px-[6rem] py-[2rem] items-start justify-start rounded-xl bg-indigo-400/60"
						@click="
							() => (modalDisplay = data.image)
						"
					>
						<img
					...
					>
						...
						<p
							class="text-gray-600 w-[87%] text-base"
						>
				...
				<teleport to="body">
						...
						>
							<swiper
								...
								:navigation="true"
								:modules="nav"
								class="w-full lg:hidden min-h-[80%] mx-auto display flex items-center justify-center"
							>
								<swiper-slide
								...
								>
									...
									>
										<div
											class="min-h-[60vh] py-4 overflow-scroll flex flex-col items-center justify-center w-[80%] bg-white pt-6 rounded-2xl"
										>
											<img
												:src="content.image"
												class="max-w-[11rem]"
		...
		<!-- Mobile Slider -->
		<div
			class="min-h-[48rem] border lg:hidden w-full"
		>
			<swiper
				:slides-per-view="1"
				:space-between="50"
...
<script setup lang="ts">
	...
	const gridData = [
		...
		{
			text:
				"An advanced messaging platform, where you can take control of your text and picture messages like never before. With our platform, you have the option to restrict screenshots, saving, copying, and forwarding of messages you send, giving you complete control over your conversations" +

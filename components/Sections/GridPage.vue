...
const gridDataMobile = [
  ...
  {
    text: "The ultimate financial management tool that combines traditional and digital banking services in one place! Our innovative platform allows you to effortlessly make and receive payments in both cash and cryptocurrency, transfer funds, pay bills, purchase airtime, data, and other digital goods using a variety of local and global payment methods. With Alpha Digital Wallet, managing your finances has never been easier. Our user-friendly interface makes it simple for you to keep track of all your transactions and account balances, and our advanced security measures ensure that your data and funds are always protected. But that's not all - by saving your money in AlphaWallets, you can enjoy higher returns than you would with a regular savings account in a bank. Our cutting-edge technology and financial expertise allow us to offer you the best possible return on your investment, without any of the hassle or risks of traditional banking. So why wait? Sign up for Alpha Digital Wallet today and start taking control of your finances like never before!",
    image: "/images/Alpha-wallet.png",
    header: "Alpha Digital wallet",
  },
];
